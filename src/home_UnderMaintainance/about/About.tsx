...
const About = () => {
  ...
  return (
    <section ref={sectionRef} className="w-full bg-[#fcfafa] space-y-24 py-20 overflow-hidden">
      <div className="flex flex-col lg:flex-row px-10 text-center space-y-8 lg:space-y-0 lg:text-start lg:px-0 w-full border-none lg:border-b  border-[#E5E3D8] ">
        ...
        <div className="lg:w-1/2 lg:px-24 font-helvetica flex flex-col gap-4 justify-center">
          ...
          <div className="lg:mt-2 lg:w-[25%]  cursor-pointer">
            <p className="text-[0.875rem] font-medium text-primary lg:border-b lg:border-black pb-1">
      ...
      <div
        ref={pinSectionRef}
        className=" relative w-full lg:min-h-screen  flex flex-col  justify-center items-center "
      >
        <div className=" lg:absolute lg:left-[5%] px-10 lg:px-0 lg:top-[15%] z-10 lg:max-w-[28rem] ">
          <h2 className="text-[2.25rem] text-center lg:text-start font-medium lg:font-normal leading-12 text-primary">
        ...
        <div className=" lg:absolute lg:right-[5%] px-10 lg:px-0 lg:bottom-[5%] z-10 lg:max-w-[22rem] ">
          ...
          <h3 className="text-[2.25rem] lg:hidden text-center lg;text-start font-medium lg:font-normal leading-10 text-primary">
            We found a better way Meet CropTab™
          </h3>

          <p className="mt-6 text-[1.125rem] text-center lg:text-start lg:text-[1rem] leading-[1.8rem] text-gray-100 lg:text-primary">
      ...
      <div className="w-full  text-2xl px-10  lg:px-20 font-helvetica lg:py-16 flex flex-col lg:flex-row  space-y-8 lg:space-y-0  justify-between  ">
        {features.map((feature, index) => (
          <div
            key={index}
            className="flex lg:w-1/4 bg-white-50 border border-white-100 rounded-xl flex-col gap-5 lg:bg-transparent lg:border-none"
          >
