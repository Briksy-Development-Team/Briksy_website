...
const PropertyListCard = ({ item }: Props) => (
  <div className="flex items-start gap-2 lg:gap-3  hover:bg-white border border-[#E7E7E4] rounded-[1.25rem]">
    ...
    <div className="flex flex-1 justify-between gap-2 lg:gap-3">
      <div className="min-w-0">
        ...
        <p className="mt-1 text-[0.75rem] font-semibold text-[#222]">
          ${item.price.toLocaleString()}
        </p>
        <p className="mt-1 text-[0.6875rem] text-[#6C6C6C]">
        ...
        <div className="mt-2 flex items-center gap-1.5">
          ...
          />
          <span className="text-[0.6875rem] text-[#6C6C6C]">
            {item.posterName}
          </span>
        </div>
      </div>
