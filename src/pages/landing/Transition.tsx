...
const Transition = forwardRef<HTMLDivElement>((_, ref) => (
  ...
  >
    {/* 
      1. COMPRESSED EASED BASE GRADIENT
      Notice how the percentage stops now end at 52%. 
      This guarantees the entire bottom half (52% to 100%) is completely solid #F8F4EE.
    */}
    <div
    ...
    {/* 
      2. ORGANIC FOG BLOBS
      Moved slightly up and scaled down so they stay in the "foggy" top half 
      and don't interfere with the solid bottom half.
    */}
    <div
    ...
    {/* 
      3. DITHERING NOISE
      Softens the math of the gradients and blends it perfectly into the image.
    */}
    <div
