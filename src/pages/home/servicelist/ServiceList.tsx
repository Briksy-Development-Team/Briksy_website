...
import Arrow from "../../../assets/service/arroe.svg"
        ...
        <section className="py-20 font-helvetica ">
            <div className="w-[95%] mx-auto">
                ...
                <div className="flex justify-between items-start">
                    <button className="flex items-center gap-2 font-medium border-[#98928E] rounded-full border px-3 py-2 text-[0.875rem]">
                ...
                <div className="mt-10 flex flex-wrap justify-center gap-4">
                    {tabs.map((tab) => (
                        <button
                            ...
                            className={`min-w-[140px] rounded-xl border border-[#DBDAD3] py-3 transition ${activeTab === tab
                ...
                <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
                    {data.map((item, index) => (
                        <div
                            key={item.id}
                            className="rounded-3xl p-4 bg-white hover:bg-[#E7D0B3]"
                        ...
                        >
                            <div className="flex gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-[#6B6B6B] font-medium text-[0.875rem]">{item.role} from</p>
                            ...
                            <div className="mt-8">
                                <p className="text-sm text-[#98928E]">Latest review</p>

                                <p className="mt-2 italic text-gray-700">"{item.review}"</p>
                            </div>
                        </div>
                    ))}
                </div>
