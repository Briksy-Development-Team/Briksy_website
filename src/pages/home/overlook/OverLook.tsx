...
const DATA: Record<Tab, CardData[]> = {
    ...
    Selling: [
        ...
        },
        {
            ...
            title: "Market trends",
            description:
                "Track buyer demand and recent sales in your neighbourhood.",
        },
    ],
    ...
    Researching: [
        ...
        },
        {
            ...
            description:
                "Compare schools, transport, crime rates and future growth.",
        },
    ],
};
            ...
            <div className="flex justify-center gap-5 mt-8 flex-wrap">
                {TABS.map((tab) => (
                    <button
                        ...
                        className={`px-8 py-2 rounded-xl border transition-all duration-300 ${activeTab === tab
            ...
            >
                {DATA[activeTab].map((item) => (
                    ...
                    >
                        ...
                        <h3 className="text-[1.8rem] font-medium mt-5">
                            {item.title}
                        </h3>
